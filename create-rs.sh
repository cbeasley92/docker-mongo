...
docker exec mongo01 mongo --eval "rs.initiate()"
docker exec mongo01 mongo --eval "rs.conf()"
docker exec mongo01 mongo --eval "rs.add(\"mongo02:27017\")"
docker exec mongo01 mongo --eval "rs.add(\"mongo03:27017\")"
